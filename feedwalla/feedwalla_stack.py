...
class FeedwallaStack(Stack):
    ...
    ### CHATBOT ###
        ...
        topic = _sns.Topic(
            self, 'topic',
            display_name = 'feedwalla',
            topic_name = 'feedwalla'
        )
    ...
    ### EXPORT LAMBDA ###
        ...
        exportalarm = _cloudwatch.Alarm(
            self, 'exportalarm',
            comparison_operator = _cloudwatch.ComparisonOperator.GREATER_THAN_THRESHOLD,
            threshold = 0,
            evaluation_periods = 1,
            metric = export.metric_errors(
